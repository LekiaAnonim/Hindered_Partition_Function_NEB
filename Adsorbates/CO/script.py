#!/usr/bin/env python3
"""
NEB calculation script for CO on Pt(111)
...
sys.path.insert(0, '/Users/lekiaprosper/Documents/CoMoChEng/ECC/Hindered_Partition_Function_NEB/Adsorbates')
...
WORKDIR = '/Users/lekiaprosper/Documents/CoMoChEng/ECC/Hindered_Partition_Function_NEB/Adsorbates/CO'
...
def main():
    ...
    screening_results = remap_paths(
        screening_results,
        '/projects/westgroup/lekia.p/NEB/Adsorbates/CO',
        WORKDIR
